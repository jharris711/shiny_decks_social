...
class TweetTestCase(TestCase):
    def setUp(self):
        ...
        self.user2 = User.objects.create_user(username='abc', password='somepassword')
    ...
    def test_tweet_create_api_view(self):
        req_data = {"content": "This is a test post!!"}
        client = self.get_client()
        response = client.post("/api/tweets/create/", req_data)
        self.assertEqual(response.status_code, 201)
